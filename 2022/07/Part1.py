...
def solve(puzzle_input):
    ...
    return sum([directory.get_size() for directory in root.get_directories() if directory.get_size() <= 100000])

def main():
    puzzle_input = util.read.as_lines()

    sizes = solve(puzzle_input)

    print("The sum of the total sizes of all of the directories with a total size of at most 100000 is " + str(sizes) + ".")

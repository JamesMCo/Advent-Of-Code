...
def solve(puzzle_input):
    ...
    return nx.shortest_path_length(area_graph, (0, 0), oxygen)

def main():
    puzzle_input = util.read.as_int_list(",")

    commands = solve(puzzle_input)

    print("The fewest number of movement commands required to reach the oxygen system is " + str(commands) + ".")

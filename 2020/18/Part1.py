...
def solve(puzzle_input):
    ...
    def evaluate(expr):
        ...
        if expr[-2] == "+":
            return evaluate(expr[:-2]) + evaluate([expr[-1]])
        elif expr[-2] == "*":
            return evaluate(expr[:-2]) * evaluate([expr[-1]])
...
class AOC_Tests(unittest.TestCase):
    def test_ex1(self):
        return self.assertEqual(solve(["1 + 2 * 3 + 4 * 5 + 6"]), 71)

    def test_ex2(self):
        return self.assertEqual(solve(["1 + (2 * 3) + (4 * (5 + 6))"]), 51)

    def test_ex3(self):
        return self.assertEqual(solve(["2 * 3 + (4 * 5)"]), 26)

    def test_ex4(self):
        return self.assertEqual(solve(["5 + (8 * 3 + 9 + 3 * 4 * 3)"]), 437)

    def test_ex5(self):
        return self.assertEqual(solve(["5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))"]), 12240)

    def test_ex6(self):
        return self.assertEqual(solve(["((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2"]), 13632)
